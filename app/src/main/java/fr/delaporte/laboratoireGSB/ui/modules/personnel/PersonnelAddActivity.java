...
public class PersonnelAddActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(v -> {
            ...
            if(TextUtils.isEmpty(password)) { edtPassword.setError(errorEmpty); return; }

            Personnel personnel = new Personnel(name, surname, email, password);
